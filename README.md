...
| 🧪 | **Active MCP Optimization Candidate** | The named local v0.23.0 installation exposes the current 15-tool control/trace and Orca adapter surface with explicit state-root and trusted-launch requirements. M1.2 installation/rollback passes; the skill-independent cold-start guidance architecture is approved as design, while implementation, model-backed execution, prompt promotion, and surface optimization remain gated and measurable. |
