...
- **Backup y artefacto HLP-211b:** `.aether/backups/hlp248-flow-blocker-routing-20260829T193117-0600`; `SHA256SUMS` conserva los cuatro archivos previos y `LEDGER.sha256` el ledger previo. Parche portable versionado: `patches/hermes/HLP-211b-flow-blocker-routing.patch`, SHA-256 `b99f11f45abca5d9d6fdac23c59d2f23086abc35018587b5f5f7c14e245dab30`; `git apply --check` y comparación byte a byte contra los cuatro archivos activos pasaron sobre una reconstrucción del backup.
