...
- **Backup y artefacto HLP-211b:** `.aether/backups/hlp248-flow-blocker-routing-20260829T193117-0600`; `SHA256SUMS` conserva los cuatro archivos previos y `LEDGER.sha256` el ledger previo. Parche portable versionado: `patches/hermes/HLP-211b-flow-blocker-routing.patch`, SHA-256 `d51339d21f5729b78c7d1d3e3e3600bd36af5e02be2976f1ba4f5089bdfe7576`; `git apply --check` y comparación byte a byte contra los cuatro archivos activos pasaron sobre una reconstrucción del backup.
