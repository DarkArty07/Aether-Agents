...
- **Portable artifact:** `patches/hermes/HLP-420-responses-terminal-fidelity.patch`, SHA-256 `a81d0126b8afe625490be21fbf345732d7bcd307382de15202f68a1fcb4645c5`. `git apply --check` passes on a freshly materialized tree at the exact base revision, and applying it reconstructs both files byte for byte (`agent/auxiliary_client.py` `2c5dfee035dd47a8bb8f2e652983f53f3ebc3b90c06adc87176f4cbf3adc0a30`; `tests/agent/test_auxiliary_client_responses_terminal_420.py` `1c8a21d09950a7bef2fbbac3b03073970f23e3eab32fd15e6e2f12cc4a1434e6`).
