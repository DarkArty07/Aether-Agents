...
- **Backup y artefacto HLP-211b:** `.aether/backups/hlp248-flow-blocker-routing-20260829T193117-0600`; `SHA256SUMS` conserva los cuatro archivos previos y `LEDGER.sha256` el ledger previo. Parche portable versionado: `patches/hermes/HLP-211b-flow-blocker-routing.patch`, SHA-256 `b7a7401bd3c3392c34e363ec1567a42589252f7c530b2ad7474e27bd48320c30`; `git apply --check` y comparación byte a byte contra los cuatro archivos activos pasaron sobre una reconstrucción del backup.
