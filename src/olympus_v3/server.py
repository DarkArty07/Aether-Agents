...
async def _handle_aether_status(args: dict) -> list[mcp_types.TextContent]:
    ...
    try:
        ...
        try:
            ...
            # Counts
            # ⚡ Bolt: Combine multiple COUNT aggregate queries into a single query with subqueries
            ...
            sessions_count = counts_row[0]
            issues_count = counts_row[1]
            decisions_count = counts_row[2]
