...
The owner-authorized Morfeo MCP objective (#515) continues in this `1.0.0rc13` source candidate. It is the forward convergence of the local rc11/rc12 reader bridges with main: rc9, rc11 and rc12 read schema 4 and schema 5, and rc13 emits schema 5 with `hermes.extras: [mcp]` and adds `aether mcp morfeo serve`. The executable Hermes pin remains `aed6591a69f453a1867b73628603e7b53ba40ffc`. This source is not an activation claim. No Hermes fork change, tag push, or stable release is authorized.
