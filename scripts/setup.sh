#!/usr/bin/env bash
# ==============================================================================
# Aether Agents v0.8.0 — Setup Script
...
# Points to .venv-hermes/bin/hermes with orchestrator profile

export HERMES_HOME=\"${PROJECT_ROOT}/home\"
exec \"${HERMES_BIN}\" -p orchestrator \"\$@\"
"
...
print_summary() {
    ...
    echo "     ${DIM}${PROJECT_ROOT}/home/profiles/orchestrator/.env${NC}"
    echo "     ${DIM}${PROJECT_ROOT}/home/profiles/hermes/.env${NC}"
    echo "     ${DIM}(and other profiles as needed)${NC}"
    echo ""
