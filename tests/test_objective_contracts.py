...
def test_supervisor_preserves_judgement_review_and_exact_escalation_boundaries() -> None:
    ...
    required = (
        ...
        "you MAY directly repair an understood, bounded defect that restores already-agreed behavior",
        "Keep substantial implementation delegated. Do not invent product intent, acceptance criteria or shared-interface decisions.",
        "Allow at most two ordinary review returns per logical unit.",
        "Stop earlier without verifiable progress or a concretely improved diagnosis.",
        "Do not issue a third ordinary return",
        "This is an instruction-level policy, not a runtime-enforced counter",
