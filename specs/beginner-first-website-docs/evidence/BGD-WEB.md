...
- Supervisor review correction is isolated in website commit
  `63ba7f31e290bc1bbb46227cfabf55708ad9b9d0`: the docs index marks the canonical
...
- The follow-up AC-11 correction is isolated in website commit `c6016a8`: the visible
  canonical-source accessible label now has effective `lang="en"`, with matching static
  and desktop/mobile browser assertions. No prior language or README correction was
  weakened.
