...
- **Isolation and witnesses**:
  ...
  - Before/after content and size witnesses are recorded on the ambient `HERMES_HOME` target across every new node, proving zero unintended writes to ambient profiles or discovery caches.
