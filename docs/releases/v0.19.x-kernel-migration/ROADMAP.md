...
|---|---|---|---|---|
| v0.19.1 | PROPOSED | One opted-in task reaches ACPManager through server-owned kernel composition. | Actual composition seam, durable admission/staging/session binding, honest uncertainty, unchanged legacy default. | Completion, review, closure, handoff, Harmonia. |
...
**Pending user decision:** approve or revise the six-patch sequence.

Approval authorizes detailed v0.19.1 planning only. It does not authorize source changes, live ACP, configuration changes, gateway restart, merge, tag, deployment or publication.
