...
Three supported surfaces inspect or repair an installation that is already active. None of them selects a different release, installs a package, acquires credentials, or rolls user state backward.
