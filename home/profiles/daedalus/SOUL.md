...
See `references/daedalus-website-pattern.md` for the complete design pattern (current state analysis, design token extraction, component structure, responsive behavior, and implementation notes).
