...
- **Team methodology**: The Aether team follows a 5-phase pipeline (IDEA → RESEARCH → DESIGN → PLAN → CODE). Full methodology in Hermes' `aether-agents:orchestration` skill. Your role is defined in sections 3 and 4.
