...
- **2026-05-08**: Specialist profiles with the same write-restriction config are also restricted. The historical runtime path is retired; this observation remains only about hermes-agent hook/toolset behavior.
